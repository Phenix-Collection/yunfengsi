...
public class add_address extends AppCompatActivity implements View.OnClickListener {
    ...
    private ArrayAdapter<String> cityAdtapter;
            ...
            public void run() {
                try {
                    ...
                    for (int i = 0; i < js.length(); i++) {
                        ...
                        provinceList.add(j.getString("name"));
                        cityList.add(j.getString("city"));
                    }
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            s1.setAdapter(new ArrayAdapter<String>(add_address.this, R.layout.spinner_text, provinceList));
                        }
                    });
    ...
    Spinner.OnItemSelectedListener onitemclicklistener = new AdapterView.OnItemSelectedListener() {
        @Override
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            if (position != 0) {
                try {
                    JSONArray js = new JSONArray(cityList.get(position - 1));
                    ...
                    citylist2.add("城市");
                    citylist2.addAll(a);
                    cityAdtapter.notifyDataSetChanged();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.add_address_commit:
                if (s1.getSelectedItem().toString().equals("省份") || s2.getSelectedItem().toString().equals("城市")) {
                    Toast.makeText(add_address.this, "请选择所在地区", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (name.getText().toString().equals("")) {
                    Toast.makeText(add_address.this, "请填写收货人姓名", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (phone.getText().toString().equals("")) {
                    Toast.makeText(add_address.this, "请填写收货人联系方式", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(!Verification.isMobileNO(phone.getText().toString())){
                    Toast.makeText(add_address.this, "请填写正确的联系方式", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (address.getText().toString().equals("")) {
                    Toast.makeText(add_address.this, "请填写收货人详细地址", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (youbian.getText().toString().equals("")||youbian.getText().toString().length()!=6) {
                    Toast.makeText(add_address.this, "请填写收货人所在地区的邮编", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (p == null) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            js.put("user_id",getSharedPreferences("user",MODE_PRIVATE).getString("user_id",""));
                            js.put("receiver",name.getText().toString());
                            js.put("phone",phone.getText().toString());
                            js.put("country","中国");
                            js.put("province",s1.getSelectedItem().toString());
                            js.put("city",s2.getSelectedItem().toString());
                            js.put("address",address.getText().toString());
                            js.put("zipcode",youbian.getText().toString());
                            ApisSeUtil.M m=ApisSeUtil.i(js);
//                            httpParams.put("user_id",getSharedPreferences("user",MODE_PRIVATE).getString("user_id",""));
//                            httpParams.put("receiver",name.getText().toString());
//                            httpParams.put("phone",phone.getText().toString());
//                            httpParams.put("country","中国");
//                            httpParams.put("province",s1.getSelectedItem().toString());
//                            httpParams.put("city",s2.getSelectedItem().toString());
//                            httpParams.put("address",address.getText().toString());
//                            httpParams.put("zipcode",youbian.getText().toString());

                            String data= OkGo.post(Constants.Shucheng_shouhuo_add_Ip)
                            ...
                            if(!TextUtils.isEmpty(data)){
                                ...
                                if(map!=null){
                                    if("000".equals(map.get("code"))){
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                p.dismiss();
                                                Toast.makeText(add_address.this, "信息提交成功", Toast.LENGTH_SHORT).show();
                                                setResult(0);
                                                finish();
                                            }
                                        });
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        p.dismiss();
                                        Toast.makeText(add_address.this, "信息提交失败，请稍后尝试", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        } catch (IOException e) {
