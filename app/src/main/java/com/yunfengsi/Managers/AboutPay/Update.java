...
public class Update extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        String zipcode1 =getIntent().getStringExtra("zipcode");
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            s1.setAdapter(new ArrayAdapter<String>(Update.this, R.layout.spinner_text, provinceList));
                        }
                    });
        ...
        switch (v.getId()) {
            ...
            case R.id.add_address_commit:
                if (s1.getSelectedItem().toString().equals("省份") || s2.getSelectedItem().toString().equals("城市")) {
                    Toast.makeText(Update.this, "请选择所在地区", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (name.getText().toString().equals("")) {
                    Toast.makeText(Update.this, "请填写收货人姓名", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (phone.getText().toString().equals("")) {
                    Toast.makeText(Update.this, "请填写收货人联系方式", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(!Verification.isMobileNO(phone.getText().toString())){
                    Toast.makeText(Update.this, "请填写正确的联系方式", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (address.getText().toString().equals("")) {
                    Toast.makeText(Update.this, "请填写收货人详细地址", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (youbian.getText().toString().equals("")||youbian.getText().toString().length()!=6) {
                    Toast.makeText(Update.this, "请填写收货人所在地区的邮编", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (p == null) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            try {
                                js.put("user_id", PreferenceUtil.getUserIncetance(Update.this).getString("user_id", ""));
                                ...
                                js.put("address_id",id);
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                            String data= OkGo.post(Constants.Shucheng_shouhuo_update_Ip)
                            ...
                            if(!TextUtils.isEmpty(data)){
                                ...
                                if(map!=null){
                                    if("000".equals(map.get("code"))){
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                p.dismiss();
                                                Toast.makeText(Update.this, "信息提交成功", Toast.LENGTH_SHORT).show();
                                                setResult(0);
                                                finish();
                                            }
                                        });
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        p.dismiss();
                                        Toast.makeText(Update.this, "信息提交失败，请稍后尝试", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        } catch (IOException e) {
