...
public class Fortune_History extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.title_title)).setText("摇签记录");
        ...
        textView.setText(mApplication.ST("暂无摇签记录"));
    ...
    private static class MessageAdapter extends BaseQuickAdapter<HashMap<String, String>> {
        ...
        protected void convert(BaseViewHolder holder, HashMap<String, String> map) {
            holder.setText(R.id.msg,map.get("title"))
                    .setText(R.id.title,map.get("num"))
