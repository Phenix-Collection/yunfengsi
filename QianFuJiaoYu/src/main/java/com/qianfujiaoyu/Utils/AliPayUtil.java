...
public class AliPayUtil {
     ...
     * 支付宝账户登录授权业务：入参pid值
     */
    public static final String PID = "2088721290745759";
    // 商户PID
    public static final String PARTNER = "2088721290745759";
    // 商户收款账号
    public static final String SELLER = "2088721290745759";
...
//                    }
                    ...
                    js.put("type", type);
                    js.put("pay_type", "2");
//                    HttpParams httpParams=new HttpParams("key",Constants.safeKey);
//                    httpParams.put("m_id",Constants.M_id);
//                    httpParams.put("address",address);
//                    httpParams.put("shop_id", attachId);
//                    httpParams.put("money", allmoney);
//                    httpParams.put("title", title);
//                    httpParams.put("user_id", PreferenceUtil.getUserIncetance(context).getString("user_id", ""));
//                    httpParams.put("receiveid", Constants.M_id);
...
//                                      String resultInfo = payResult.getResult();// 同步返回需要验证的信息
                                        ...
                                        if (TextUtils.equals(resultStatus, "9000")) {
                                            ...
                                            mApplication.dingdan_commit.finish();
