...
public class mItemDeraction extends RecyclerView.ItemDecoration {
        ...
        public mItemDeraction(int space) {
            this.space = space;
        }

        public mItemDeraction(int space, int color) {
            this.space = space;
            this.color = color;
        ...
        public mItemDeraction(int space, Drawable mDivider) {
            this.space = space;
