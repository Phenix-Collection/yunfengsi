 ...
 */
public class LoadMoreListViewExpand extends ExpandableListView implements OnScrollListener {
    public View footer;
    ...
    public LoadMoreListViewExpand(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LoadMoreListViewExpand(Context context, AttributeSet attrs, int defStyle) {
