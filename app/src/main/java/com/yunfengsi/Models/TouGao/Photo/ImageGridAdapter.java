package com.yunfengsi.Models.TouGao.Photo;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (getItemViewType(position) == 0) {
            ...
            Glide.with(context).load(path).override((mScreenWidth - dp4) / 3, (mScreenWidth - dp4) / 3)
                    .skipMemoryCache(true).centerCrop().into(holder.imageView);
            holder.check.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!mSelectedImages.contains(path)) {
                        ...
                        ((ImageView) v).setImageResource(R.drawable.pick_checkbox_bg);
