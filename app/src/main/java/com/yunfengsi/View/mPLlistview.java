 ...
 */
public class mPLlistview extends ListView {
    public boolean isOnMeasure=false;
    public TextView footer;
    private static final String TAG = "mPLlistview";
    public mPLlistview(Context context) {
        super(context);
        init(context);
    }

    public mPLlistview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);

    }

    public mPLlistview(Context context, AttributeSet attrs, int defStyleAttr) {
