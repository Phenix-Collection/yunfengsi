package com.maimaizu.citypicker.adapter;
...
import com.maimaizu.citypicker.utils.PinyinUtils;
...
public class CityListAdapter extends BaseAdapter {
    ...
    public CityListAdapter(List<City> mCities) {
            ...
            case 0:     //定位
                ...
                switch (locateState){
                    case LocateState.LOCATING:
                        state.setText(R.string.cp_locating);
                        break;
                            ...
                            if (onCityClickListener != null){
                                if(mCities!=null){
                                    for(City city:mCities){
                                        ...
                                        if(name.contains(locatedCity)||locatedCity.contains(name)){
                                            onCityClickListener.onCityClick(locatedCity,city.getId());
                                            return;
                                        }
                                    }
                                }
                                onCityClickListener.onCityClick(locatedCity,"-1");
                            }
                        }
                    }
                });
            ...
            case 1:     //所有
                ...
                if (position >= 0){
                    ...
                    holder.name.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (onCityClickListener != null){
                                onCityClickListener.onCityClick(city,mCities.get(position).getId());
                            }
                        }
                    });
                }
