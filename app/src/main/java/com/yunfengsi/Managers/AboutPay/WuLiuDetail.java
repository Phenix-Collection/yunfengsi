...
import com.yunfengsi.View.mWuLiuDecoration;
...
public class WuLiuDetail extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    private class wuliuAdapter extends BaseQuickAdapter<HashMap<String, String>,BaseViewHolder> {
