...
public class NianFo_Detail extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LinearLayout right_Fragment = findViewById(R.id.niaofo_detail_fragment);
        tab1 = findViewById(R.id.nianfo_detail_tab1);
        tab1.setText(mApplication.ST("念佛"));
        tab2 = findViewById(R.id.nianfo_detail_tab2);
        tab2.setText(mApplication.ST("诵经"));
        tab3 = findViewById(R.id.nianfo_detail_tab3);
        tab3.setText(mApplication.ST("持咒"));
        ListView list = findViewById(R.id.niaofo_detail_list);
