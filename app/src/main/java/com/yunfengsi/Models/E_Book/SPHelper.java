...
public class SPHelper {
    private SharedPreferences config = mApplication.getInstance().getSharedPreferences("config",Context.MODE_PRIVATE);
    private SharedPreferences.Editor configEditor = config.edit();
    private SharedPreferences bookmark =mApplication.getInstance().getSharedPreferences("bookmark",Context.MODE_PRIVATE);
    ...
    public int getFontSize(){
        return config.getInt("font_size",25);
    }
