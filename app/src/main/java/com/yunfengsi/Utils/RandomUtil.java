...
public class RandomUtil {
    ...
    public static final String ALLCHAR_EXCPT0 = "123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    ...
    public static String generateString(int length) {
        ...
        for (int i = 0; i < length; i++) {
            if(i==0){
                sb.append(ALLCHAR_EXCPT0.charAt(random.nextInt(ALLCHAR_EXCPT0.length())));
            }else{
