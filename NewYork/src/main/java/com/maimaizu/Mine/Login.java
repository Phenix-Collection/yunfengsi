            ...
            case R.id.Login_login://登录
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            response = OkGo.post(Constants.Login_Ip).tag(TAG).params("phone", username.getText().toString())
                                    .params("m_id", Constants.M_id)
                                    .params("password", password.getText().toString())
                                    .params("key", Constants.safeKey)
                                    .params("type", type).execute();
...
//        ( findViewById(R.id.login_bg)).setBackgroundDrawable(null);
    ...
    public static class LoginNeedLoadModel {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case -1:
                    ...
                    Intent intent4 = new Intent(Login.this, HomeActivity.class);
                    startActivity(intent4);
                    Intent intent = new Intent("Mine");
                    Intent intent1 = new Intent("live");
                    sendBroadcast(intent);
                    sendBroadcast(intent1);
                    EventBus.getDefault().post(new LoginNeedLoadModel());
