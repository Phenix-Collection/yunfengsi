...
//    private static String notify = Constants.host_Ip + "/api.php/Api/" + "Qpay_url";
...
//
//
//    public  void registQPay(Context context) {
//
//    }
//
//    public static boolean IsMqqInstalled(IOpenApi openApi) {
...
//    }
//
//    public static boolean IsMqqSupportPay(IOpenApi openApi) {
...
//
//
//    public static void openQQPay( Activity context, final String attach, final String title, final String allmoney, final String num, final String type, final String extra) {
//        final WeakReference<Activity> weakReference=new WeakReference<Activity>(context);
//        final IOpenApi openApi = OpenApiFactory.getInstance(weakReference.get(), APP_ID);
//        if (!IsMqqInstalled(openApi)) {
//            return;
//        }
//        if (!IsMqqSupportPay(openApi)) {
//            return;
//        }
...
//                            js.put("title", title);
//                            js.put("user_id", PreferenceUtil.getUserIncetance(weakReference.get()).getString("user_id", ""));
//                            js.put("receiveid", Constants.M_id);
//                            js.put("num", num);
//                            js.put("shop_id", attach);
//                            js.put("type",type);
//                            js.put("pay_type", "3");
//                    String attachIdData = OkGo.post(Constants.getAttachId_ip).tag(weakReference.get())
//
...
//                            mApplication.id=attach;
//                            mApplication.title=title;
//                            money = m.get("money");
//                            LogUtil.e("换回的订单值：" +  mApplication.sut_id  + "   总金额：" + money);
//                            String Ip = getLocalHostIp();
//                            String nonce_str = System.currentTimeMillis() + "";
//                            StringBuilder a = new StringBuilder();
//                            a
//                                    .append("appid=").append(APP_ID)
//                                    .append("&attach=").append( mApplication.sut_id )
...
//                            root.addText("\n").addElement("attach").addText( mApplication.sut_id );
...
//                                @Override
//                                public void run() {
//                                    ProgressUtil.show(weakReference.get(), "", "正在调起QQ钱包，请稍等");
//                                }
//                            });
//                            new Thread(new Runnable() {
//                                @Override
//                                public void run() {
//                                    try {
//                                        String data = OkGo.post(getOrderNoUrl).upString(document.getRootElement().asXML())
//                                                .execute().body().string();
//                                        if (!data.equals("")) {
//                                            HashMap<String, String> m = (HashMap<String, String>) WXPayUtils.readStringXmlOut(data);
//                                            LogUtil.e("返回的数据：" + m);
//                                            tokenId = m.get("prepay_id");
//                                            beginQQPay(weakReference.get(),openApi);
//                                        }
//                                    } catch (Exception e) {
//                                        e.printStackTrace();
//
...
//
//
//    public static void beginQQPay(Context context,IOpenApi openApi) {
