...
public class GK_NF_Adapter extends BaseAdapter{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            ...
            hoder.mtvtime= view.findViewById(R.id.mine_gk_lf_itme_tvtime);
            hoder.mlinearLayout= view.findViewById(R.id.layout);
            view.setTag(hoder);
        }else {
        ...
        String data=valueList.get(i);
            for (HashMap<String, String> map : AnalyticalJSON.getList_zj(data)) {
                ...
                TextView tvnj = view1.findViewById(R.id.itme_tvnianjingname);
                TextView tvs = view1.findViewById(R.id.itme_tvnianjingnum);
                TextView tvtime = view1.findViewById(R.id.itme_tvnianjingtime);
                switch (type) {
                    case "念佛":
