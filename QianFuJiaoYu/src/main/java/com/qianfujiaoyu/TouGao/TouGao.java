    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tougao_commit:
                ...
                if (content_edt.getText().toString().equals("") && titleFile == null &&
                        mImages.size() == 1 && videoFile == null) {
...
//                    }
                    ...
                    if (videoFile != null) {
                        ...
                        Log.w(TAG, "onClick: videoFile-__+_+_+_+_+__>文件大小：" + videoFile.length());
                    }
                    ...
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                            OkGo.post(Constants.upload_image).params(httpParams)   .params("key",m.K())
