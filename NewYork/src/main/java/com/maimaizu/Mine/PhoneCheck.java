        ...
        switch (v.getId()) {
            ...
            case R.id.zhuce_commit:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            String data = OkGo.post(Constants.Phone_Commit_Ip).params("key", Constants.safeKey).params("user_id", sp.getString("user_id", ""))
                                    .params("phone", phone.getText().toString()).execute().body().string();
            ...
            case R.id.Zhuce_getMid:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String data1 = null;
                        try {
                            data1 = OkGo.post(Constants.Mid_IP).tag(TAG).params("phone", phone.getText().toString()).params("key", Constants.safeKey)
