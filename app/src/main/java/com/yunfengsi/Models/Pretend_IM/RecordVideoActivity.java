...
public class RecordVideoActivity extends Activity implements View.OnClickListener {
    ...
    public void initView() {
        ((TextView) findViewById(R.id.title_title)).setText("录制视频");
        ...
        progressVideo.setMax(movieRecorderView.getRecordMaxTime());
...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RES_CODE) {
            Log.w(TAG, "onClick: "+data.getStringExtra("path"));
            setResult(RES_CODE,data);
            finish();
        }
    }
}