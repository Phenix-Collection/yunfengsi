...
import com.yunfengsi.Models.Pretend_IM.Utils.recordAudio;
import com.yunfengsi.Models.TouGao.TouGaoGridAdapter;
import com.yunfengsi.Models.TouGao.mDialog;
import com.yunfengsi.Models.TouGao.mGridView;
                                    ...
                                    mAudioView.setOnImageClickListener(new mAudioView.onImageClickListener() {
                                        ...
                                        public void onImageClick(final mAudioView v) {
                                            ...
                                            if (!mAudioView.isPlaying()) {
                                                ...
                                                mAudioManager.playSound(Ask_Detail.this,v, map.get("options"), new MediaPlayer.OnCompletionListener() {
                                                    @Override
...
//        scrollView= (ScrollView) findViewById(R.id.scroll);
        ...
        gridAdapter = new TouGaoGridAdapter(this, imglist, false,1);
...
//                        }
                ...
                view.findViewById(R.id.pic).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        PhotoUtilNormal.choosePic(Ask_Detail.this, 0);
                    }
                });
    ...
    public class chatAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.head.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(a, GerenxinxiActivity.class);
            ...
            if (!map.get("contents").equals("")) {
                ...
                holder.image.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ScaleImageUtil.openBigIagmeMode(Ask_Detail.this,map.get("image"),true);
                ...
                holder.audio.setOnImageClickListener(new mAudioView.onImageClickListener() {
                    ...
                    public void onImageClick(final mAudioView v) {
                        ...
                        if (!v.isPlaying()) {
                            Log.w(TAG, "onImageClick: 开始播放");
                            mAudioManager.playSound(Ask_Detail.this,v, map.get("video"), new MediaPlayer.OnCompletionListener() {
                                @Override
                                public void onCompletion(MediaPlayer mp) {
                                    v.resetAnim();
                                }
