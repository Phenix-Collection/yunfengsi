...
import com.qianfujiaoyu.Utils.NumUtils;
...
//                holder.player = (JCVideoPlayerStandard) view.findViewById(R.id.zixun_video_player);
            ...
            if(!bean.get("videourl").endsWith("mp3")){
                ...
                if(holder.stub.getChildAt(0) instanceof JCVideoPlayerStandard){
                    ...
                    jc0.setUp(bean.get("videourl"),JCVideoPlayer.SCREEN_LAYOUT_LIST,bean.get("title"));
                    ...
                    jc.setUp(bean.get("videourl"),JCVideoPlayer.SCREEN_LAYOUT_LIST,bean.get("title"));
