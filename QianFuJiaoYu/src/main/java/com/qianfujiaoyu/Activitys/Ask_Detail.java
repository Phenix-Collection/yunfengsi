...
import com.qianfujiaoyu.TouGao.mGridView;
...
//    private ProgressBar p1;//加载数据的底部进度
    ...
    protected void onCreate(Bundle savedInstanceState) {
        StatusBarCompat.compat(this, ActivityCompat.getColor(this,R.color.main_color));
                        ...
                        if (map != null) {
                            ...
                            if (map.get("options") != null && !map.get("options").equals("")) {
                                if (map.get("options").endsWith(".mp4")) {
                                    ...
                                    j.setLayoutParams(l);
                                    options.addView(j);
                                    j.setUp(map.get("options"), JCVideoPlayer.SCREEN_LAYOUT_NORMAL,"  ");
...
//                                            p.dismiss();
    ...
    private void uploadAudio() {
        ...
        LogUtil.e("发送语音：：" + js);
        ApisSeUtil.M m = ApisSeUtil.i(js);
        OkGo.post(Constants.Chat_Content_UpLoad)
                .params("key", m.K())
                .params("msg", m.M())
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            LogUtil.e("发送文字：：" + js);
                            ApisSeUtil.M m = ApisSeUtil.i(js);
                            final String data = OkGo.post(Constants.Chat_Content_UpLoad)
                                    .params("key", m.K())
        ...
        if (requestCode == 0 && resultCode == RESULT_OK) {
            ...
            view.findViewById(R.id.commit).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Tiny.getInstance().source(ImageUtil.getImageAbsolutePath(Ask_Detail.this, finalUri)).asFile().compress(new com.zxy.tiny.callback.FileCallback() {
                        @Override
    ...
    public class chatAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.head.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(a, User_Detail.class);
            ...
            if (!map.get("contents").equals("")) {
                ...
                holder.image.setVisibility(View.GONE);
                holder.audio.setVisibility(View.GONE);
                holder.player.setUp(map.get("video"), JCVideoPlayer.SCREEN_LAYOUT_LIST, "");
            }
